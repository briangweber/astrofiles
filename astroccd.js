...
const { readKeywords, getNumericKeyword } = require("./fits/keywordreader");
const { tryLinkSharedCalibration, tryLinkLibraryCalibration } = require("./linkcommon");
...
const doTheAsyncThings = async () => {
  ...
  for(directoryData of directoriesToRename) {
